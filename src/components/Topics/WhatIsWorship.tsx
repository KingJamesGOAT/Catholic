    ...
    >
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">I</span>
        ...
        <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="p-4 bg-gray-800/50 rounded-lg border-l-4 border-yellow-500">
              <h4 className="text-white font-semibold mb-2">{t(trans.section1.synagogueTitle, language)}</h4>
              <p className="text-sm text-gray-400">{t(trans.section1.synagogueDesc, language)}</p>
            </div>
            <div className="p-4 bg-gray-800/50 rounded-lg border-l-4 border-blue-500">
              <h4 className="text-white font-semibold mb-2">{t(trans.section1.templeTitle, language)}</h4>
              <p className="text-sm text-gray-400">{t(trans.section1.templeDesc, language)}</p>
            </div>
          </div>
          <p className="mt-4 italic text-gray-400">{t(trans.section1.conclusion, language)}</p>
        </div>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">II</span>
        ...
        <div className="space-y-4 text-gray-300">
          ...
          <p className="text-blue-300 italic">"{t(trans.section2.cccQuote, language)}"</p>
        </div>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">III</span>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">IV</span>
        ...
        <div className="space-y-4 text-gray-300">
          ...
          <p className="text-blue-300 italic">"{t(trans.section4.cccQuote, language)}"</p>
        </div>
      </section>

      {/* Video Section 2 */}
      <div className="mb-12">
        <h3 className="text-xl font-semibold text-white mb-4">{t(trans.video2Title, language)}</h3>
        <div className="aspect-video rounded-xl overflow-hidden border border-gray-800 shadow-2xl">
          <iframe
            className="w-full h-full"
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">V</span>
          {t(trans.section5.title, language)}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-gray-900/50 rounded-xl border border-gray-800">
            <h3 className="text-xl font-bold text-white mb-2">{t(trans.section5.liturgyWord, language)}</h3>
            <p className="text-gray-400 text-sm">{t(trans.section5.liturgyWordDesc, language)}</p>
          </div>
          <div className="p-6 bg-gray-900/50 rounded-xl border border-gray-800">
            <h3 className="text-xl font-bold text-white mb-2">{t(trans.section5.liturgyEucharist, language)}</h3>
            <p className="text-gray-400 text-sm">{t(trans.section5.liturgyEucharistDesc, language)}</p>
          </div>
        </div>
        <p className="mt-4 text-gray-400 text-center italic">{t(trans.section5.emmausRef, language)}</p>
      </section>

      {/* Section 6: Personal Encounter */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">VI</span>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-sm">VII</span>
          {t(trans.section7.title, language)}
        </h2>
        <div className="space-y-6 text-gray-300">
          <div>
            <p className="mb-2 font-semibold text-white">{t(trans.section7.communionTitle, language)}</p>
            <ul className="list-disc pl-6 space-y-1 text-gray-400">
              <li>{t(trans.section7.c1, language)}</li>
              <li>{t(trans.section7.c2, language)}</li>
              <li>{t(trans.section7.c3, language)}</li>
            </ul>
            <p className="text-blue-300 italic mt-2">"{t(trans.section7.cccQuote, language)}"</p>
          </div>
          <div>
            <p className="mb-2 font-semibold text-white">{t(trans.section7.strengthTitle, language)}</p>
            <ul className="list-disc pl-6 space-y-1 text-gray-400">
      ...
      <div className="bg-blue-900/20 border border-blue-800 rounded-xl p-8 text-center mb-12">
        <h3 className="text-2xl font-bold text-white mb-4">{t(trans.conclusion.title, language)}</h3>
        ...
        <p className="text-sm text-blue-400 mt-2">{t(trans.conclusion.source, language)}</p>
      </div>
