        ...
        >
          ...
          <div className="my-8 flex justify-center">
            ...
            <Dialog>
              ...
              {/* Modal Content with Blur Background */}

              <DialogContent className="w-[95vw] md:w-[90vw] max-w-7xl max-h-[60vh] md:max-h-[90vh] overflow-y-auto bg-black/90 border-gray-800 backdrop-blur-xl p-4 md:p-8 rounded-2xl">

                <DialogHeader className="mb-4 md:mb-6 pr-8"> {/* Added pr-8 to avoid text overlapping close button */}

                  <DialogTitle className="text-2xl md:text-4xl font-bold text-white mb-2">The Early Church Fathers</DialogTitle>

                  <DialogDescription className="text-gray-400 text-sm md:text-lg">

                    Historical evidence for the Catholic nature of the early Church.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  ...
                  <div className="space-y-3 group">
                     ...
                     <h3 className="text-base md:text-lg text-gray-200 font-semibold leading-snug group-hover:text-blue-400 transition-colors">
                       ...
                       The Bible and the Fathers Made me Catholic
                  ...
                  <div className="space-y-3 group">
                     ...
                     <h3 className="text-base md:text-lg text-gray-200 font-semibold leading-snug group-hover:text-blue-400 transition-colors">
                       ...
                       Part 1: How St. Ignatius 'Red Pilled' Me
                  ...
                  <div className="space-y-3 group">
                     ...
                     <h3 className="text-base md:text-lg text-gray-200 font-semibold leading-snug group-hover:text-blue-400 transition-colors">
                       ...
                       Part 2: How St. Ignatius 'Red Pilled' Me
