  ...
  const timelineEvents = [
    {
      ...
      title: "Pentecost",
      description:
        "The Holy Spirit descends on the apostles, marking the birth of the Church.",
    ...
    },
    {
      ...
      description:
        "The founding apostles give their lives in Rome for Christ.",
    ...
    },
    {
      ...
      description:
        "The first ecumenical council defines Christ's divinity against Arianism.",
    ...
    },
    {
      ...
      description:
        "Mary affirmed as Theotokos (Mother of God).",
    ...
    },
    {
      ...
      description:
        "Martin Luther's theses spark widespread division.",
    ...
    },
    {
      ...
      description:
        "Catholic doctrine clarified and reforms enacted.",
    ...
    <PageSection>
      ...
      >
        ...
        <p className="text-gray-400 text-center mb-12 max-w-3xl mx-auto">
          A journey through 2,000 years of faith, witness, and
          ...
          <div className="space-y-12">
            {timelineEvents.map((event, index) => (
              ...
              >
                ...
                {/* Content */}
                <div
                  className={`w-full md:w-5/12 ml-8 md:ml-0 ${index % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}
                >
                  <div
