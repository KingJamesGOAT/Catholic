...
export const earlyChurchTopics: EarlyChurchTopic[] = [
  ...
  de: "Er war nicht nur ein herausragender Lehrer, sondern auch ein hervorragender Märtyrer, dessen Martyrium alle nachzuahmen begehren, da es ganz mit dem Evangelium Christi übereinstimmte. Denn nachdem er durch Geduld den ungerechten Statthalter überwunden und so die Krone der Unsterblichkeit erlangt hatte, verherrlicht er nun freudig mit den Aposteln und allen Gerechten [im Himmel] Gott, den Vater, und segnet unseren Herrn Jesus Christus, den Retter unserer Seelen, den Lenker unserer Leiber und den Hirten der katholischen Kirche in der ganzen Welt.",
...

      {
        ...
        work: {
          en: "Refutation of All Heresies",
          fr: "Réfutation de toutes les hérésies",
          es: "Refutación de todas las herejías",
          de: "Widerlegung aller Häresien",
        },
        date: "c. 225 AD",
        text: {
          en: "Behold, into how great impiety that lawless one has proceeded, by inculcating adultery and murder at the same time! And withal, after such audacious acts, they, lost to all shame, attempt to call themselves a Catholic Church!",
          fr: "Voyez dans quelle grande impiété ce sans-loi s'est engagé, en inculquant l'adultère et le meurtre en même temps ! Et de plus, après de tels actes audacieux, perdus à toute honte, ils tentent de s'appeler une Église catholique !",
          es: "¡Mirad en qué gran impiedad ha caído ese sin ley, inculcando el adulterio y el asesinato al mismo tiempo! Y además, después de tales actos audaces, perdidos a toda vergüenza, ¡intentan llamarse a sí mismos una Iglesia Católica!",
          de: "Seht, in welch große Gottlosigkeit dieser Gesetzlose geraten ist, indem er Ehebruch und Mord zugleich lehrt! Und obendrein, nach solch dreisten Taten, versuchen sie, aller Scham bar, sich eine katholische Kirche zu nennen!",
        },
...

      {
        ...
        work: {
          en: "Extant Writings",
          fr: "Écrits existants",
          es: "Escritos existentes",
          de: "Vorhandene Schriften",
        },
        date: "c. 232 AD",
        text: {
          en: "But the same arrogant spirit taught them to revile the Church universal under heaven... For when the faithful throughout Asia met together often... and rejected them as heretical, they were in consequence of that expelled from the Church...",
          fr: "Mais le même esprit arrogant leur a appris à insulter l'Église universelle sous le ciel... Car lorsque les fidèles à travers l'Asie se réunissaient souvent... et les rejetaient comme hérétiques, ils étaient en conséquence expulsés de l'Église...",
          es: "Pero el mismo espíritu arrogante les enseñó a injuriar a la Iglesia universal bajo el cielo... Porque cuando los fieles de toda Asia se reunían a menudo... y los rechazaban como herejes, eran en consecuencia expulsados de la Iglesia...",
          de: "Aber derselbe arrogante Geist lehrte sie, die universale Kirche unter dem Himmel zu schmähen... Denn als die Gläubigen in ganz Asien oft zusammenkamen... und sie als ketzerisch ablehnten, wurden sie infolgedessen aus der Kirche ausgeschlossen...",
        },
        sourceReference: "Ch. 2",
      },

      {
        ...
        work: {
          en: "On the Trinity",
          fr: "Sur la Trinité",
          es: "Sobre la Trinidad",
          de: "Über die Trinität",
        },
        date: "c. 250 AD",
        text: {
          en: "But because heretics, ever struggling against the truth, are accustomed to prolong the controversy of pure tradition and Catholic faith, being offended against Christ... we must rightly—that every heretical calumny may be removed from our faith—contend...",
          fr: "Mais parce que les hérétiques, luttant toujours contre la vérité, ont l'habitude de prolonger la controverse de la pure tradition et de la foi catholique, étant offensés contre le Christ... nous devons à juste titre — pour que toute calomnie hérétique soit ôtée de notre foi — combattre...",
          es: "Pero porque los herejes, luchando siempre contra la verdad, acostumbran prolongar la controversia de la pura tradición y la fe católica, ofendidos contra Cristo... debemos justamente —para que toda calumnia herética sea eliminada de nuestra fe— contender...",
          de: "Aber weil Häretiker, die immer gegen die Wahrheit kämpfen, gewohnt sind, die Kontroverse um die reine Tradition und den katholischen Glauben zu verlängern, da sie an Christus Anstoß nehmen... müssen wir zu Recht – damit jede häretische Verleumdung von unserem Glauben entfernt wird – kämpfen...",
        },
        sourceReference: "Ch. 30",
      },
...

      {
        ...
        work: {
          en: "On the Unity of the Church",
          fr: "Sur l'Unité de l'Église",
          es: "Sobre la Unidad de la Iglesia",
          de: "Über die Einheit der Kirche",
        },
        date: "251 AD",
        text: {
          en: "But how can he agree with anyone who does not agree with the body of the Church itself, and with the universal brotherhood? How can two or three be assembled together in Christ’s name, who, it is evident, are separated from Christ and from His Gospel?",
          fr: "Mais comment peut-il s'accorder avec quelqu'un qui ne s'accorde pas avec le corps de l'Église elle-même, et avec la fraternité universelle ? Comment deux ou trois peuvent-ils être assemblés au nom du Christ, eux qui, il est évident, sont séparés du Christ et de Son Évangile ?",
          es: "¿Pero cómo puede estar de acuerdo con alguien que no está de acuerdo con el cuerpo de la Iglesia misma, y con la hermandad universal? ¿Cómo pueden dos o tres reunirse en nombre de Cristo, quienes, es evidente, están separados de Cristo y de Su Evangelio?",
          de: "Wie aber kann er mit jemandem übereinstimmen, der nicht mit dem Leib der Kirche selbst und mit der universalen Bruderschaft übereinstimmt? Wie können zwei oder drei im Namen Christi versammelt sein, die offensichtlich von Christus und Seinem Evangelium getrennt sind?",
        },
        sourceReference: "Treatise 1, §12",
      },
      {
        id: "cyprian-letter-40",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "251 AD",
        text: {
          en: "And lest their raging boldness should ever cease, they are striving here also to distract the members of Christ into schismatical parties, and to cut and tear the one body of the Catholic Church...",
          fr: "Et de peur que leur audace furieuse ne cesse jamais, ils s'efforcent ici aussi de distraire les membres du Christ dans des partis schismatiques, et de couper et déchirer le corps unique de l'Église catholique...",
          es: "Y para que su furiosa audacia no cese nunca, se esfuerzan aquí también por distraer a los miembros de Cristo en partidos cismáticos, y cortar y desgarrar el único cuerpo de la Iglesia Católica...",
          de: "Und damit ihre wütende Kühnheit niemals aufhört, streben sie auch hier danach, die Glieder Christi in schismatische Parteien zu zerstreuen und den einen Leib der katholischen Kirche zu zerschneiden und zu zerreißen...",
        },
        sourceReference: "§2",
      },
      {
        id: "cyprian-letter-43",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "251 AD",
        text: {
          en: "...contrary to evangelical law, contrary to the unity of the Catholic institution, had consented that another bishop should be made. That is what is neither right nor allowable to be done... that Christ’s members should be torn asunder...",
          fr: "...contrairement à la loi évangélique, contrairement à l'unité de l'institution catholique, avaient consenti à ce qu'un autre évêque soit nommé. C'est ce qui n'est ni juste ni permis... que les membres du Christ soient déchirés...",
          es: "...contrario a la ley evangélica, contrario a la unidad de la institución católica, habían consentido que se hiciera otro obispo. Eso es lo que no es correcto ni permitido hacer... que los miembros de Cristo sean desgarrados...",
          de: "...entgegen dem evangelischen Gesetz, entgegen der Einheit der katholischen Institution, zugestimmt hatten, dass ein anderer Bischof ernannt würde. Das ist weder recht noch zulässig... dass die Glieder Christi zerrissen werden sollten...",
        },
        sourceReference: "To Maximus",
      },
      {
        id: "cyprian-letter-44",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "251 AD",
        text: {
          en: "We know that we have exhorted them to acknowledge and hold the root and matrix of the Catholic Church... and maintain both you [Pope Cornelius] and your communion, that is as well to the unity of the Catholic Church as to its charity...",
          fr: "Nous savons que nous les avons exhortés à reconnaître et à tenir la racine et la matrice de l'Église catholique... et à maintenir à la fois vous [Pape Corneille] et votre communion, c'est-à-dire aussi bien à l'unité de l'Église catholique qu'à sa charité...",
          es: "Sabemos que los hemos exhortado a reconocer y sostener la raíz y la matriz de la Iglesia Católica... y mantener tanto a usted [Papa Cornelio] como a su comunión, que es tanto para la unidad de la Iglesia Católica como para su caridad...",
          de: "Wir wissen, dass wir sie ermahnt haben, die Wurzel und den Mutterboden der katholischen Kirche anzuerkennen und zu halten... und sowohl Sie [Papst Cornelius] als auch Ihre Gemeinschaft zu bewahren, das heißt sowohl zur Einheit der katholischen Kirche als auch zu ihrer Nächstenliebe...",
        },
        sourceReference: "§3",
      },
      {
        id: "cyprian-letter-51",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "251 AD",
        text: {
          en: "...in spite of God’s tradition, in spite of the combined and everywhere compacted unity of the Catholic Church, is endeavoring to make a human church, and is sending his new apostles through very many cities...",
          fr: "...en dépit de la tradition de Dieu, en dépit de l'unité combinée et partout compacte de l'Église catholique, s'efforce de faire une église humaine, et envoie ses nouveaux apôtres à travers de très nombreuses villes...",
          es: "...a pesar de la tradición de Dios, a pesar de la unidad combinada y compactada en todas partes de la Iglesia Católica, está tratando de hacer una iglesia humana, y está enviando a sus nuevos apóstoles a través de muchísimas ciudades...",
          de: "...trotz Gottes Tradition, trotz der kombinierten und überall kompakten Einheit der katholischen Kirche, versucht er, eine menschliche Kirche zu machen, und sendet seine neuen Apostel durch sehr viele Städte...",
        },
        sourceReference: "§24",
      },
      {
        id: "cyprian-letter-54",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "252 AD",
        text: {
          en: "Is the dignity of the Catholic Church, dearest brother, to be laid aside... that those who are set without the Church may say that they wish to judge concerning a prelate in the Church?",
          fr: "La dignité de l'Église catholique, très cher frère, doit-elle être mise de côté... pour que ceux qui sont placés hors de l'Église puissent dire qu'ils souhaitent juger un prélat dans l'Église ?",
          es: "¿Ha de dejarse de lado la dignidad de la Iglesia Católica, queridísimo hermano... para que los que están fuera de la Iglesia digan que desean juzgar sobre un prelado en la Iglesia?",
          de: "Soll die Würde der katholischen Kirche, liebster Bruder, beiseitegelegt werden... damit diejenigen, die außerhalb der Kirche stehen, sagen können, dass sie über einen Prälaten in der Kirche urteilen wollen?",
        },
        sourceReference: "§18",
      },
      {
        id: "cyprian-letter-66",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "254 AD",
        text: {
          en: "Marcianus... has departed from the unity of the Catholic Church... while the Bishop Cornelius was ordained in the Catholic Church by the judgment of God... Therefore, if he were willing to return to a right mind... he should repent and return to the Church as a suppliant.",
          fr: "Marcien... s'est écarté de l'unité de l'Église catholique... alors que l'évêque Corneille a été ordonné dans l'Église catholique par le jugement de Dieu... Par conséquent, s'il voulait revenir à un esprit droit... il devrait se repentir et retourner à l'Église en suppliant.",
          es: "Marciano... se ha apartado de la unidad de la Iglesia Católica... mientras que el obispo Cornelio fue ordenado en la Iglesia Católica por el juicio de Dios... Por lo tanto, si estuviera dispuesto a volver a su sano juicio... debería arrepentirse y volver a la Iglesia como suplicante.",
          de: "Marcianus... ist von der Einheit der katholischen Kirche abgewichen... während Bischof Cornelius in der katholischen Kirche durch das Urteil Gottes ordiniert wurde... Wenn er also bereit wäre, zu einem rechten Verstand zurückzukehren... sollte er bereuen und als Bittsteller zur Kirche zurückkehren.",
        },
        sourceReference: "§§1-2",
      },
      {
        id: "cyprian-letter-68",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "254 AD",
        text: {
          en: "Peter speaks there, on whom the Church was to be built, teaching and showing in the name of the Church... that he is not in the Church... while the Church, which is Catholic and one, is not cut nor divided, but is indeed connected and bound together by the cement of priests who cohere with one another.",
          fr: "Pierre parle là, sur qui l'Église devait être bâtie, enseignant et montrant au nom de l'Église... qu'il n'est pas dans l'Église... tandis que l'Église, qui est catholique et une, n'est ni coupée ni divisée, mais est en effet connectée et liée ensemble par le ciment des prêtres qui sont cohérents les uns avec les autres.",
          es: "Pedro habla allí, sobre quien la Iglesia iba a ser edificada, enseñando y mostrando en nombre de la Iglesia... que no está en la Iglesia... mientras que la Iglesia, que es Católica y una, no se corta ni se divide, sino que está conectada y unida por el cemento de los sacerdotes que son coherentes entre sí.",
          de: "Petrus spricht dort, auf dem die Kirche gebaut werden sollte, und lehrt und zeigt im Namen der Kirche... dass er nicht in der Kirche ist... während die Kirche, die katholisch und eins ist, weder zerschnitten noch geteilt ist, sondern in der Tat verbunden und zusammengehalten wird durch den Zement der Priester, die zusammenhalten.",
        },
        sourceReference: "§8",
      },
      {
        ...
        date: "c. 256 AD",
        text: {
          en: "For Novatian... wishes to claim to himself the authority and truth of the Catholic Church... But if any one objects, by way of saying that Novatian holds the same law which the Catholic Church holds... know first of all, that there is not one law of the Creed, nor the same interrogatory common to us and to schismatics.",
          fr: "Car Novatien... souhaite revendiquer pour lui-même l'autorité et la vérité de l'Église catholique... Mais si quelqu'un objecte, en disant que Novatien détient la même loi que l'Église catholique... sachez tout d'abord qu'il n'y a pas une seule loi du Credo, ni le même interrogatoire commun à nous et aux schismatiques.",
          es: "Porque Novaciano... desea reclamar para sí la autoridad y la verdad de la Iglesia Católica... Pero si alguien objeta, diciendo que Novaciano sostiene la misma ley que sostiene la Iglesia Católica... sepa primero que nada, que no hay una sola ley del Credo, ni el mismo interrogatorio común a nosotros y a los cismáticos.",
          de: "Denn Novatian... möchte die Autorität und Wahrheit der katholischen Kirche für sich beanspruchen... Aber wenn jemand einwendet und sagt, dass Novatian dasselbe Gesetz hält, das die katholische Kirche hält... wisse zuerst, dass es nicht ein Gesetz des Glaubensbekenntnisses gibt, noch denselben Verhörmodus, der uns und den Schismatikern gemeinsam ist.",
        },
        sourceReference: "§§1, 7",
      },
      {
        ...
        author: {
          ...
          fr: "Firmilien de Cappadoce",
          es: "Firmiliano de Capadocia",
          de: "Firmilian von Kappadokien",
        },
        work: {
          en: "Letter 74",
          fr: "Lettre 74",
        ...
        date: "256 AD",
        text: {
          en: "But the enemies of the one Catholic Church in which we are, and the adversaries of us who have succeeded the apostles, asserting for themselves, in opposition to us, unlawful priesthoods... what else are they than Korah, Dathan, and Abiram?",
          fr: "Mais les ennemis de la seule Église catholique dans laquelle nous sommes, et nos adversaires qui avons succédé aux apôtres, affirmant pour eux-mêmes, en opposition à nous, des sacerdoces illégaux... que sont-ils d'autre que Koré, Dathan et Abiram ?",
          es: "Pero los enemigos de la única Iglesia Católica en la que estamos, y los adversarios de nosotros que hemos sucedido a los apóstoles, afirmando para sí mismos, en oposición a nosotros, sacerdocios ilegales... ¿qué otra cosa son que Coré, Datán y Abiram?",
          de: "Aber die Feinde der einen katholischen Kirche, in der wir sind, und die Widersacher von uns, die wir den Aposteln nachgefolgt sind, die für sich selbst, im Gegensatz zu uns, unrechtmäßige Priestertümer beanspruchen... was sind sie anderes als Korach, Dathan und Abiram?",
        },
        sourceReference: "§16",
      },
      {
        id: "dionysius-alex-letter-11",
        author: {
          en: "St. Dionysius the Great",
          fr: "Saint Denys le Grand",
          es: "San Dionisio el Grande",
          de: "Hl. Dionysius der Große",
        },
        work: {
          en: "Letter 11: To Hermammon",
          fr: "Lettre 11 : À Hermammon",
          es: "Carta 11: A Hermamón",
          de: "Brief 11: An Hermammon",
        },
        date: "c. 260 AD",
        text: {
          en: "Wherefore he also became an enemy to His Catholic Church; and besides that, he alienated and estranged himself from the mercy of God...",
          fr: "C'est pourquoi il est aussi devenu un ennemi de Son Église catholique ; et en outre, il s'est aliéné et éloigné de la miséricorde de Dieu...",
          es: "Por lo cual también se convirtió en enemigo de Su Iglesia Católica; y además de eso, se alienó y extrañó de la misericordia de Dios...",
          de: "Deshalb wurde er auch ein Feind Seiner katholischen Kirche; und außerdem entfremdete und entfernte er sich von der Barmherzigkeit Gottes...",
        },
        sourceReference: "Letter 11",
      },
      {
        id: "gregory-thaumaturgus-trinity",
        author: {
        ...
        work: {
          en: "A Fragment from On the Trinity",
          fr: "Un Fragment de Sur la Trinité",
          es: "Un Fragmento de Sobre la Trinidad",
          de: "Ein Fragment aus Über die Trinität",
        },
        date: "c. 260 AD",
        text: {
          en: "But if anyone, moreover, believes that any increment has been given to the Trinity... he is an alien from us, and from the ministry of the Catholic and Apostolic Church.",
          fr: "Mais si quelqu'un, de plus, croit qu'un accroissement a été donné à la Trinité... il est étranger à nous, et au ministère de l'Église catholique et apostolique.",
          es: "Pero si alguien, además, cree que se ha dado algún incremento a la Trinidad... es un extraño para nosotros, y para el ministerio de la Iglesia Católica y Apostólica.",
          de: "Aber wenn jemand darüber hinaus glaubt, dass der Trinität irgendein Zuwachs gegeben wurde... ist er ein Fremder für uns und für den Dienst der katholischen und apostolischen Kirche.",
        },
      ...
      },
      {
        id: "malchion-letter",
        author: {
          en: "Malchion of Antioch",
          fr: "Malchion d'Antioche",
          es: "Malquion de Antioquía",
          de: "Malchion von Antiochien",
        },
        work: {
          en: "Letter Against Paul of Samosata",
          fr: "Lettre Contre Paul de Samosate",
          es: "Carta Contra Pablo de Samosata",
          de: "Brief gegen Paul von Samosata",
        },
        date: "272 AD",
        text: {
          en: "To Dionysius and Maximum, and to all our fellows in the ministry throughout the world... and to the whole Catholic Church under heaven... We have been compelled... to appoint in his place another bishop for the Catholic Church...",
          fr: "À Denys et Maxime, et à tous nos compagnons de ministère dans le monde entier... et à toute l'Église catholique sous le ciel... Nous avons été contraints... de nommer à sa place un autre évêque pour l'Église catholique...",
          es: "A Dionisio y Máximo, y a todos nuestros compañeros en el ministerio en todo el mundo... y a toda la Iglesia Católica bajo el cielo... Nos hemos visto obligados... a nombrar en su lugar otro obispo para la Iglesia Católica...",
          de: "An Dionysius und Maximus und an alle unsere Amtsbrüder auf der ganzen Welt... und an die ganze katholische Kirche unter dem Himmel... Wir waren gezwungen... an seiner Stelle einen anderen Bischof für die katholische Kirche zu ernennen...",
        },
        sourceReference: "§§1, 5",
      },
      {
        id: "anatolius-paschal",
        author: {
          en: "Saint Anatolius of Laodicea",
          fr: "Saint Anatole de Laodicée",
          es: "San Anatolio de Laodicea",
          de: "Hl. Anatolius von Laodicea",
        },
        work: {
          en: "The Paschal Canon",
          fr: "Le Canon Pascal",
          es: "El Canon Pascual",
          de: "Der Osterkanon",
        },
        date: "270 AD",
        text: {
          en: "And as this has been sanctioned by the charge of the Lord, and is in all things accordant with the Catholic faith... And, accordingly, this only is it sufficient for all the saints and Catholics to observe...",
          fr: "Et comme cela a été sanctionné par la charge du Seigneur, et est en toutes choses conforme à la foi catholique... Et, par conséquent, cela seul suffit à tous les saints et catholiques d'observer...",
          es: "Y como esto ha sido sancionado por el cargo del Señor, y está en todas las cosas de acuerdo con la fe católica... Y, en consecuencia, esto solo es suficiente para que todos los santos y católicos lo observen...",
          de: "Und da dies durch den Auftrag des Herrn sanktioniert wurde und in allen Dingen mit dem katholischen Glauben übereinstimmt... Und dementsprechend ist dies allein ausreichend, dass alle Heiligen und Katholiken es beachten...",
        },
        sourceReference: "Ch. 15",
      },
      {
        id: "victorinus-apocalypse",
        author: {
          en: "Saint Victorinus of Pettau",
          fr: "Saint Victorin de Pettau",
          es: "San Victorino de Pettau",
          de: "Hl. Viktorin von Pettau",
        },
        work: {
          en: "Commentary on the Apocalypse",
          fr: "Commentaire sur l'Apocalypse",
          es: "Comentario sobre el Apocalipsis",
          de: "Kommentar zur Apokalypse",
        },
        date: "c. 300 AD",
        text: {
          en: "In the whole world Paul taught that all the churches are arranged by sevens... and that the Catholic Church is one... For the Catholic Church holds those things which were both before predicted and afterwards accomplished...",
          fr: "Dans le monde entier, Paul a enseigné que toutes les églises sont disposées par sept... et que l'Église catholique est une... Car l'Église catholique tient ces choses qui ont été à la fois prédites auparavant et accomplies ensuite...",
          es: "En todo el mundo Pablo enseñó que todas las iglesias están dispuestas por sietes... y que la Iglesia Católica es una... Porque la Iglesia Católica sostiene aquellas cosas que fueron predichas antes y cumplidas después...",
          de: "In der ganzen Welt lehrte Paulus, dass alle Kirchen in Siebenern angeordnet sind... und dass die katholische Kirche eins ist... Denn die katholische Kirche hält jene Dinge fest, die sowohl vorhergesagt als auch später erfüllt wurden...",
        },
        sourceReference: "Ch. 1, 4, 12",
      },
      {
        ...
        work: {
          en: "The Acts of Peter of Alexandria",
          fr: "Les Actes de Pierre d'Alexandrie",
          es: "Las Actas de Pedro de Alejandría",
          de: "Die Akten des Petrus von Alexandrien",
        },
        date: "311 AD",
        text: {
          en: "Meletius lastly... was made the schismatical bishop... rending asunder the Catholic Church... Arius had not been cut off from the Catholic unity without a divine interposition.",
          fr: "Mélèce enfin... fut fait évêque schismatique... déchirant l'Église catholique... Arius n'avait pas été coupé de l'unité catholique sans une intervention divine.",
          es: "Melecio finalmente... fue hecho obispo cismático... desgarrando la Iglesia Católica... Arrio no había sido cortado de la unidad católica sin una interposición divina.",
          de: "Meletius schließlich... wurde zum schismatischen Bischof gemacht... und zerriss die katholische Kirche... Arius war nicht ohne göttliches Eingreifen von der katholischen Einheit abgeschnitten worden.",
        },
        sourceReference: "Acts",
      },
      {
        id: "methodius-oration",
        author: {
        ...
        date: "c. 300 AD",
        text: {
          en: "Hail to you, you Catholic Church, which has been planted in all the earth, and rejoice with us.",
          fr: "Salut à toi, toi Église catholique, qui as été plantée sur toute la terre, et réjouis-toi avec nous.",
          es: "Salve a ti, Iglesia Católica, que has sido plantada en toda la tierra, y regocíjate con nosotros.",
          de: "Sei gegrüßt, du katholische Kirche, die du auf der ganzen Erde gepflanzt bist, und freue dich mit uns.",
        },
        sourceReference: "§13",
      },
      {
        id: "lactantius-institutes",
        author: {
          en: "Lactantius",
          fr: "Lactance",
          es: "Lactancio",
        ...
        work: {
          en: "Divine Institutes",
          fr: "Institutions Divines",
          es: "Instituciones Divinas",
          de: "Göttliche Unterweisungen",
        },
        date: "c. 310 AD",
        text: {
          en: "Therefore it is the Catholic Church alone which retains true worship... the true Catholic Church is that in which there is confession and repentance...",
          fr: "C'est pourquoi c'est l'Église catholique seule qui conserve le vrai culte... la vraie Église catholique est celle où il y a confession et repentance...",
          es: "Por lo tanto, es la Iglesia Católica sola la que retiene el verdadero culto... la verdadera Iglesia Católica es aquella en la que hay confesión y arrepentimiento...",
          de: "Daher ist es die katholische Kirche allein, die den wahren Gottesdienst bewahrt... die wahre katholische Kirche ist diejenige, in der es Bekenntnis und Reue gibt...",
        },
        sourceReference: "Book 4, Ch. 30",
      },
      {
        id: "alexander-letter-alexander",
        author: {
          en: "St. Alexander of Alexandria",
          fr: "Saint Alexandre d'Alexandrie",
          es: "San Alejandro de Alejandría",
          de: "Hl. Alexander von Alexandrien",
        },
        work: {
          en: "Letter to Alexander of Constantinople",
          fr: "Lettre à Alexandre de Constantinople",
          es: "Carta a Alejandro de Constantinopla",
          de: "Brief an Alexander von Konstantinopel",
        },
        date: "321 AD",
        text: {
          en: "And besides, also, one only Catholic and Apostolic Church, which can never be destroyed, though all the world should seek to make war with it...",
          fr: "Et en outre, aussi, une seule Église catholique et apostolique, qui ne peut jamais être détruite, bien que le monde entier cherche à lui faire la guerre...",
          es: "Y además, también, una sola Iglesia Católica y Apostólica, que nunca puede ser destruida, aunque todo el mundo busque hacerle la guerra...",
          de: "Und außerdem auch eine einzige katholische und apostolische Kirche, die niemals zerstört werden kann, auch wenn die ganze Welt versuchen sollte, Krieg mit ihr zu führen...",
        },
        sourceReference: "§12",
      },
      {
        id: "alexander-catholic-epistle",
        author: {
          en: "St. Alexander of Alexandria",
          fr: "Saint Alexandre d'Alexandrie",
          es: "San Alejandro de Alejandría",
        ...
        work: {
          en: "Catholic Epistle",
          fr: "Épître Catholique",
          es: "Epístola Católica",
          de: "Katholischer Brief",
        },
        date: "c. 321 AD",
        text: {
          en: "Since the body of the Catholic Church is one... we have consistently anathematized such men... and have declared them to be aliens from the Catholic Church and faith...",
          fr: "Puisque le corps de l'Église catholique est un... nous avons constamment anathématisé de tels hommes... et les avons déclarés étrangers à l'Église et à la foi catholique...",
          es: "Dado que el cuerpo de la Iglesia Católica es uno... hemos anatematizado consistentemente a tales hombres... y los hemos declarado extraños a la Iglesia y la fe Católica...",
          de: "Da der Leib der katholischen Kirche eins ist... haben wir solche Männer konsequent mit dem Kirchenbann belegt... und sie zu Fremden für die katholische Kirche und den Glauben erklärt...",
        },
        sourceReference: "§§1, 6",
      },
      {
        id: "alexander-letter-priests",
        author: {
          en: "St. Alexander of Alexandria",
          fr: "Saint Alexandre d'Alexandrie",
          es: "San Alejandro de Alejandría",
        ...
        work: {
          en: "Letter to Priests and Deacons",
          fr: "Lettre aux Prêtres et Diacres",
          es: "Carta a Sacerdotes y Diáconos",
          de: "Brief an Priester und Diakone",
        },
        date: "c. 321 AD",
        text: {
          en: "urging them to abjure their impiety, and to obey the wholesome and Catholic faith; and in this manner have shown your orthodox purpose, and your agreement in the doctrines of the Catholic Church...",
          fr: "les exhortant à abjurer leur impiété, et à obéir à la foi saine et catholique ; et de cette manière ont montré votre dessein orthodoxe, et votre accord dans les doctrines de l'Église catholique...",
          es: "instándolos a abjurar de su impiedad, y a obedecer la fe sana y católica; y de esta manera han mostrado su propósito ortodoxo, y su acuerdo en las doctrinas de la Iglesia Católica...",
          de: "sie drängend, ihre Gottlosigkeit abzuschwören und dem heilsamen und katholischen Glauben zu gehorchen; und auf diese Weise haben sie ihren orthodoxen Vorsatz und ihre Übereinstimmung in den Lehren der katholischen Kirche gezeigt...",
        },
...

  {
    ...
    quotes: [
...

      {
        ...
        date: "c. 200 AD",
        text: {
          en: "Was anything withheld from the knowledge of Peter, who is called 'the rock on which the church should be built', who also obtained 'the keys of the kingdom of heaven', with the power of 'loosing and binding in heaven and on earth'?",
          fr: "Quelque chose a-t-il été caché à la connaissance de Pierre, qui est appelé 'le roc sur lequel l'Église devait être bâtie', qui a aussi obtenu 'les clés du royaume des cieux', avec le pouvoir de 'lier et délier au ciel et sur la terre' ?",
          es: "¿Se le ocultó algo al conocimiento de Pedro, quien es llamado 'la roca sobre la cual la iglesia debía ser edificada', quien también obtuvo 'las llaves del reino de los cielos', con el poder de 'atar y desatar en el cielo y en la tierra'?",
          de: "Wurde dem Wissen des Petrus etwas vorenthalten, der 'der Fels, auf dem die Kirche gebaut werden sollte' genannt wird, der auch 'die Schlüssel des Himmelreichs' erhielt, mit der Macht, 'im Himmel und auf Erden zu binden und zu lösen'?",
        },
        sourceReference: "§22",
      },
      {
        id: "tertullian-prescription-36",
        author: {
          en: "Tertullian",
          fr: "Tertullien",
          es: "Tertuliano",
        ...
        date: "c. 200 AD",
        text: {
          en: "Come now... run over the apostolic churches... Since, moreover, you are close upon Italy, you have Rome, from which there comes even into our own hands the very authority (of apostles themselves). How happy is its church, on which apostles poured forth all their doctrine along with their blood!",
          fr: "Venez maintenant... parcourez les églises apostoliques... Puisque, de plus, vous êtes proche de l'Italie, vous avez Rome, d'où nous vient même entre nos propres mains l'autorité même (des apôtres eux-mêmes). Combien heureuse est son église, sur laquelle les apôtres ont versé toute leur doctrine avec leur sang !",
          es: "Ven ahora... recorre las iglesias apostólicas... Puesto que, además, estás cerca de Italia, tienes a Roma, de donde nos llega incluso a nuestras propias manos la misma autoridad (de los apóstoles mismos). ¡Cuán feliz es su iglesia, sobre la cual los apóstoles derramaron toda su doctrina junto con su sangre!",
          de: "Wohlan... durchlauft die apostolischen Kirchen... Da ihr außerdem nahe bei Italien seid, habt ihr Rom, von wo uns sogar die Autorität (der Apostel selbst) in die Hände kommt. Wie glücklich ist ihre Kirche, über die die Apostel ihre ganze Lehre zusammen mit ihrem Blut ausgegossen haben!",
        },
        sourceReference: "§36",
      },
      {
      ...
      },
      {
        ...
        work: {
          en: "Scorpiace",
          fr: "Scorpiace (Antidote contre les Scorpions)",
          es: "Scorpiace",
          de: "Scorpiace",
        },
        date: "c. 211 AD",
        text: {
          en: "For though you think heaven still shut, remember that the Lord left here to Peter and through him to the Church, the keys of it...",
          fr: "Car bien que vous pensiez que le ciel est encore fermé, rappelez-vous que le Seigneur a laissé ici à Pierre et par lui à l'Église, les clés de celui-ci...",
          es: "Porque aunque pienses que el cielo sigue cerrado, recuerda que el Señor dejó aquí a Pedro y a través de él a la Iglesia, las llaves del mismo...",
          de: "Denn obwohl du denkst, der Himmel sei noch verschlossen, denke daran, dass der Herr hier Petrus und durch ihn der Kirche die Schlüssel dazu hinterlassen hat...",
        },
      ...
      },
      {
        ...
        date: "c. 220 AD",
        text: {
          en: "If, because the Lord has said to Peter, 'Upon this rock will I build My Church, to you have I given the keys of the heavenly kingdom'... you therefore presume that the power of binding and loosing has derived to you, that is, to every Church akin to Peter...",
          fr: "Si, parce que le Seigneur a dit à Pierre : 'Sur ce roc je bâtirai mon Église, à toi j'ai donné les clés du royaume céleste'... vous présumez donc que le pouvoir de lier et de délier vous est parvenu, c'est-à-dire à toute Église apparentée à Pierre...",
          es: "Si, porque el Señor dijo a Pedro: 'Sobre esta roca edificaré mi Iglesia, a ti te he dado las llaves del reino celestial'... presumes por tanto que el poder de atar y desatar ha derivado a ti, es decir, a toda Iglesia afín a Pedro...",
          de: "Wenn du, weil der Herr zu Petrus gesagt hat: 'Auf diesen Felsen will ich meine Kirche bauen, dir habe ich die Schlüssel des Himmelreichs gegeben'... deshalb annimmst, dass die Macht des Bindens und Lösens auf dich übergegangen ist, das heißt auf jede Kirche, die Petrus verwandt ist...",
        },
        sourceReference: "Ch. 21",
      },
      {
        id: "origen-exodus-5-4",
        author: {
          en: "Origen",
          fr: "Origène",
          es: "Orígenes",
        ...
        work: {
          en: "Homily 5 on Exodus",
          fr: "Homélie 5 sur l'Exode",
          es: "Homilía 5 sobre el Éxodo",
          de: "Homilie 5 über Exodus",
        },
        date: "c. 248 AD",
        text: {
          en: "Look at that great foundation of the Church, its most solid rock upon which Christ founded the Church. What does the Lord say [to Peter]? 'Why did you doubt, O you of little faith?'",
          fr: "Regardez ce grand fondement de l'Église, son roc le plus solide sur lequel le Christ a fondé l'Église. Que dit le Seigneur [à Pierre] ? 'Pourquoi as-tu douté, homme de peu de foi ?'",
          es: "Mirad ese gran fundamento de la Iglesia, su roca más sólida sobre la cual Cristo fundó la Iglesia. ¿Qué dice el Señor [a Pedro]? '¿Por qué dudaste, hombre de poca fe?'",
          de: "Schau auf jenes große Fundament der Kirche, ihren festesten Felsen, auf den Christus die Kirche gründete. Was sagt der Herr [zu Petrus]? 'Warum hast du gezweifelt, du Kleingläubiger?'",
        },
        sourceReference: "§4",
      },
      {
        id: "origen-matthew-13-31",
        author: {
          en: "Origen",
          fr: "Origène",
          es: "Orígenes",
        ...
        date: "c. 249 AD",
        text: {
          en: "...Peter should have some element superior to those who thrice admonished... this saying 'I will give to you the keys of the kingdom of the heavens' (Matt. 16:19), has been specially set before the words, 'And whatever things you shall bind on earth,' etc.",
          fr: "...Pierre devrait avoir un élément supérieur à ceux qui ont trois fois admonesté... cette parole 'Je te donnerai les clés du royaume des cieux' (Mat. 16:19), a été spécialement placée avant les mots, 'Et tout ce que tu lieras sur la terre', etc.",
          es: "...Pedro debería tener algún elemento superior a aquellos que amonestaron tres veces... este dicho 'Te daré las llaves del reino de los cielos' (Mat. 16:19), ha sido puesto especialmente antes de las palabras, 'Y todo lo que ates en la tierra', etc.",
          de: "...Petrus sollte ein Element haben, das denen überlegen ist, die dreimal ermahnten... dieser Ausspruch 'Ich werde dir die Schlüssel des Himmelreichs geben' (Mt 16,19) wurde speziell vor die Worte gesetzt: 'Und was auch immer du auf Erden binden wirst', usw.",
        },
        sourceReference: "Book 13, Ch. 31",
      },
      {
        id: "origen-john-5-3",
        author: {
        ...
        work: {
          ...
          fr: "Commentaire sur Jean",
          es: "Comentario sobre Juan",
          de: "Johannes-Kommentar",
        },
        date: "c. 250 AD",
        text: {
          en: "And Peter, on whom the Church of Christ is built, against which the gates of Hades shall not prevail...",
          fr: "Et Pierre, sur qui l'Église du Christ est bâtie, contre laquelle les portes de l'Hadès ne prévaudront pas...",
          es: "Y Pedro, sobre quien está edificada la Iglesia de Cristo, contra la cual las puertas del Hades no prevalecerán...",
          de: "Und Petrus, auf dem die Kirche Christi erbaut ist, gegen die die Pforten der Hölle nicht überwältigen werden...",
        },
        sourceReference: "Book 5, §3",
      },
      {
        id: "caius-disputation",
        author: {
          en: "Caius the Presbyter",
          fr: "Caius le Prêtre",
          es: "Cayo el Presbítero",
        ...
        work: {
          en: "Disputation with Proclus (in Eusebius)",
          fr: "Dispute avec Proclus (dans Eusèbe)",
          es: "Disputa con Proclo (en Eusebio)",
          de: "Disputation mit Proclus (in Eusebius)",
        },
        date: "c. 210 AD",
        text: {
          en: "But I can show the trophies of the apostles. For if you will go to the Vatican or to the Ostian way, you will find the trophies of those who laid the foundations of this church.",
          fr: "Mais je peux montrer les trophées des apôtres. Car si vous allez au Vatican ou sur la voie d'Ostie, vous trouverez les trophées de ceux qui ont posé les fondations de cette église.",
          es: "Pero yo puedo mostrar los trofeos de los apóstoles. Porque si vas al Vaticano o a la vía Ostiense, encontrarás los trofeos de aquellos que pusieron los cimientos de esta iglesia.",
          de: "Aber ich kann die Siegeszeichen der Apostel zeigen. Denn wenn du zum Vatikan oder zur Via Ostiensis gehst, wirst du die Siegeszeichen derer finden, die die Fundamente dieser Kirche gelegt haben.",
        },
...

      {
        ...
        date: "251 AD",
        text: {
          en: "We know that Cornelius is bishop of the most holy Catholic Church elected by Almighty God... and that in the Catholic Church there ought to be one bishop.",
          fr: "Nous savons que Corneille est évêque de la très sainte Église catholique élue par Dieu Tout-Puissant... et que dans l'Église catholique il doit y avoir un seul évêque.",
          es: "Sabemos que Cornelio es obispo de la santísima Iglesia Católica elegida por Dios Todopoderoso... y que en la Iglesia Católica debe haber un solo obispo.",
          de: "Wir wissen, dass Cornelius Bischof der heiligsten katholischen Kirche ist, erwählt von Gott dem Allmächtigen... und dass es in der katholischen Kirche einen Bischof geben muss.",
        },
        sourceReference: "§2",
      },
      {
        ...
        work: {
          en: "On the Unity of the Catholic Church",
          fr: "Sur l'Unité de l'Église Catholique",
          es: "Sobre la Unidad de la Iglesia Católica",
          de: "Über die Einheit der katholischen Kirche",
        },
        date: "251 AD",
        text: {
          en: "The Lord speaks to Peter: 'I say to thee,' He says, 'thou art Peter, and upon this rock I will build my church...' Upon him, being one, He builds His Church... He established by His authority the origin of the same unity as beginning from one.",
          fr: "Le Seigneur parle à Pierre : 'Je te dis', dit-Il, 'tu es Pierre, et sur cette pierre je bâtirai mon église...' Sur lui, étant un, Il bâtit Son Église... Il a établi par Son autorité l'origine de la même unité comme commençant par un.",
          es: "El Señor habla a Pedro: 'Yo te digo', dice Él, 'tú eres Pedro, y sobre esta roca edificaré mi iglesia...' Sobre él, siendo uno, edifica Su Iglesia... Estableció por Su autoridad el origen de la misma unidad comenzando desde uno.",
          de: "Der Herr spricht zu Petrus: 'Ich sage dir', spricht Er, 'du bist Petrus, und auf diesen Felsen will ich meine Kirche bauen...' Auf ihm, der einer ist, baut Er Seine Kirche... Er begründete durch Seine Autorität den Ursprung derselben Einheit, indem sie von einem ausgeht.",
        },
        sourceReference: "Treatise 1, §4",
      },
      {
        id: "cyprian-letter-39",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "251 AD",
        text: {
          en: "There is one God, and Christ is one, and there is one Church, and one chair founded upon the rock by the word of the Lord.",
          fr: "Il y a un seul Dieu, et le Christ est un, et il y a une seule Église, et une seule chaire fondée sur le roc par la parole du Seigneur.",
          es: "Hay un solo Dios, y Cristo es uno, y hay una sola Iglesia, y una sola cátedra fundada sobre la roca por la palabra del Señor.",
          de: "Es gibt einen Gott, und Christus ist einer, und es gibt eine Kirche und einen Stuhl, der durch das Wort des Herrn auf den Felsen gegründet ist.",
        },
        sourceReference: "§5",
      },
      {
        ...
        date: "251 AD",
        text: {
          en: "...we have exhorted them to acknowledge and hold the root and matrix of the Catholic Church... that so the whole of our colleagues might decidedly approve of and maintain both you and your communion...",
          fr: "...nous les avons exhortés à reconnaître et à tenir la racine et la matrice de l'Église catholique... afin que l'ensemble de nos collègues puisse approuver et maintenir résolument à la fois vous et votre communion...",
          es: "...los hemos exhortado a reconocer y sostener la raíz y la matriz de la Iglesia Católica... para que así todos nuestros colegas puedan aprobar y mantener decididamente tanto a usted como a su comunión...",
          de: "...wir haben sie ermahnt, die Wurzel und den Mutterboden der katholischen Kirche anzuerkennen und zu halten... damit alle unsere Kollegen sowohl Sie als auch Ihre Gemeinschaft entschieden billigen und aufrechterhalten...",
        },
        sourceReference: "§3",
      },
      {
        id: "cyprian-letter-46",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "251 AD",
        text: {
          en: "I profess that I both have rendered and do render the greatest thanks... that the Church is thus divinely protected, and its unity and holiness is not constantly nor altogether corrupted by the obstinacy of perfidy...",
          fr: "Je professe que j'ai rendu et que je rends les plus grandes grâces... que l'Église soit ainsi divinement protégée, et que son unité et sa sainteté ne soient pas constamment ni totalement corrompues par l'obstination de la perfidie...",
          es: "Profeso que he rendido y rindo las mayores gracias... de que la Iglesia esté así divinamente protegida, y su unidad y santidad no sean constante ni totalmente corrompidas por la obstinación de la perfidia...",
          de: "Ich bekenne, dass ich den größten Dank abgestattet habe und abstatte... dass die Kirche so göttlich beschützt wird und ihre Einheit und Heiligkeit nicht ständig noch gänzlich durch die Hartnäckigkeit der Treulosigkeit korrumpiert wird...",
        },
        sourceReference: "§1",
      },
      {
        ...
        date: "252 AD",
        text: {
          en: "...when the place of Fabian, that is, when the place of Peter and the degree of the sacerdotal throne was vacant... he cannot have the ordination of the Church who does not hold the unity of the Church.",
          fr: "...lorsque la place de Fabien, c'est-à-dire lorsque la place de Pierre et le degré du trône sacerdotal étaient vacants... il ne peut avoir l'ordination de l'Église celui qui ne tient pas l'unité de l'Église.",
          es: "...cuando el lugar de Fabián, es decir, cuando el lugar de Pedro y el grado del trono sacerdotal estaba vacante... no puede tener la ordenación de la Iglesia quien no sostiene la unidad de la Iglesia.",
          de: "...als der Platz von Fabian, das heißt, als der Platz von Petrus und der Rang des priesterlichen Throns vakant war... kann derjenige nicht die Ordination der Kirche haben, der nicht an der Einheit der Kirche festhält.",
        },
        sourceReference: "§8",
      },
      {
        id: "cyprian-letter-54-7",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "252 AD",
        text: {
          en: "Nevertheless, Peter, upon whom by the same Lord the Church had been built, speaking one for all, and answering with the voice of the Church, says, 'Lord, to whom shall we go?'",
          fr: "Néanmoins, Pierre, sur qui par le même Seigneur l'Église avait été bâtie, parlant un pour tous, et répondant avec la voix de l'Église, dit : 'Seigneur, à qui irions-nous ?'",
          es: "Sin embargo, Pedro, sobre quien por el mismo Señor había sido edificada la Iglesia, hablando uno por todos, y respondiendo con la voz de la Iglesia, dice: 'Señor, ¿a quién iremos?'",
          de: "Dennoch sagt Petrus, auf dem durch denselben Herrn die Kirche gebaut worden war, einer für alle sprechend und mit der Stimme der Kirche antwortend: 'Herr, zu wem sollen wir gehen?'",
        },
        sourceReference: "§7",
      },
      {
        id: "cyprian-letter-54-14",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "252 AD",
        text: {
          en: "...to set sail and to bear letters from schismatic and profane persons to the throne of Peter, and to the chief church whence priestly unity takes its source; and not to consider that these were the Romans whose faith was praised... to whom faithlessness could have no access.",
          fr: "...de faire voile et de porter des lettres de personnes schismatiques et profanes au trône de Pierre, et à l'église principale d'où l'unité sacerdotale tire sa source ; et de ne pas considérer que c'étaient les Romains dont la foi a été louée... auxquels l'infidélité ne pouvait avoir accès.",
          es: "...zarpar y llevar cartas de personas cismáticas y profanas al trono de Pedro, y a la iglesia principal de donde nace la unidad sacerdotal; y no considerar que estos eran los romanos cuya fe fue alabada... a quienes la infidelidad no podía tener acceso.",
          de: "...in See zu stechen und Briefe von schismatischen und profanen Personen zum Thron Petri und zur Hauptkirche zu bringen, aus der die priesterliche Einheit entspringt; und nicht zu bedenken, dass dies die Römer waren, deren Glaube gepriesen wurde... zu denen Treulosigkeit keinen Zugang haben konnte.",
        },
        sourceReference: "§14",
      },
      {
        ...
        date: "254 AD",
        text: {
          en: "Peter speaks there, on whom the Church was to be built... Whence you ought to know that the bishop is in the Church, and the Church in the bishop...",
          fr: "Pierre parle là, sur qui l'Église devait être bâtie... D'où vous devez savoir que l'évêque est dans l'Église, et l'Église dans l'évêque...",
          es: "Pedro habla allí, sobre quien la Iglesia iba a ser edificada... De donde debéis saber que el obispo está en la Iglesia, y la Iglesia en el obispo...",
          de: "Petrus spricht dort, auf dem die Kirche gebaut werden sollte... Woher ihr wissen sollt, dass der Bischof in der Kirche ist und die Kirche im Bischof...",
        },
        sourceReference: "§8",
      },
      {
        id: "cyprian-letter-72",
        author: {
          en: "Saint Cyprian of Carthage",
          fr: "Saint Cyprien de Carthage",
          es: "San Cipriano de Cartago",
        ...
        date: "256 AD",
        text: {
          en: "For first of all the Lord gave that power to Peter, upon whom He built the Church, and whence He appointed and showed the source of unity...",
          fr: "Car tout d'abord le Seigneur a donné ce pouvoir à Pierre, sur qui Il a bâti l'Église, et d'où Il a désigné et montré la source de l'unité...",
          es: "Porque primero que nada el Señor dio ese poder a Pedro, sobre quien edificó la Iglesia, y de donde designó y mostró la fuente de unidad...",
          de: "Denn zuallererst gab der Herr diese Macht Petrus, auf dem Er die Kirche baute und von wo Er die Quelle der Einheit bestimmte und zeigte...",
        },
        sourceReference: "§7",
      },

      {
        id: "firmilian-letter-74-stephen",
        author: {
          en: "Firmilian of Cappadocia",
          fr: "Firmilien de Cappadoce",
          es: "Firmiliano de Capadocia",
        ...
        date: "256 AD",
        text: {
          en: "Stephen, who announces that he holds by succession the throne of Peter, is stirred with no zeal against heretics...",
          fr: "Étienne, qui annonce qu'il détient par succession le trône de Pierre, n'est animé d'aucun zèle contre les hérétiques...",
          es: "Esteban, que anuncia que ocupa por sucesión el trono de Pedro, no se mueve con celo contra los herejes...",
          de: "Stephanus, der verkündet, dass er durch Nachfolge den Thron Petri innehat, wird von keinem Eifer gegen Häretiker bewegt...",
        },
        sourceReference: "§17",
      },

      {
        ...
        date: "255 AD",
        text: {
          en: "Novatian is not in the Church; nor can he be reckoned as a bishop... For he who has not been ordained in the Church can neither have nor hold to the Church in any way.",
          fr: "Novatien n'est pas dans l'Église ; il ne peut pas non plus être compté comme évêque... Car celui qui n'a pas été ordonné dans l'Église ne peut ni avoir ni tenir à l'Église d'aucune manière.",
          es: "Novaciano no está en la Iglesia; ni puede ser contado como obispo... Porque el que no ha sido ordenado en la Iglesia no puede tener ni aferrarse a la Iglesia de ninguna manera.",
          de: "Novatian ist nicht in der Kirche; noch kann er als Bischof gerechnet werden... Denn wer nicht in der Kirche ordiniert wurde, kann die Kirche weder haben noch an ihr festhalten.",
        },
        sourceReference: "§3",
      },
      {
        id: "peter-alex-canonical",
        author: {
          en: "Saint Peter of Alexandria",
          fr: "Saint Pierre d'Alexandrie",
          es: "San Pedro de Alejandría",
        ...
        work: {
          ...
          fr: "Lettre Canonique",
          es: "Carta Canónica",
          de: "Kanonischer Brief",
        },
        date: "306 AD",
        text: {
          en: "Thus Peter, the first of the apostles, having been often apprehended, and thrown into prison, and treated with ignominy, was last of all crucified at Rome.",
          fr: "Ainsi Pierre, le premier des apôtres, ayant été souvent appréhendé, et jeté en prison, et traité avec ignominie, fut le dernier de tous crucifié à Rome.",
          es: "Así Pedro, el primero de los apóstoles, habiendo sido apresado a menudo, y arrojado a prisión, y tratado con ignominia, fue crucificado el último de todos en Roma.",
          de: "So wurde Petrus, der erste der Apostel, nachdem er oft ergriffen, ins Gefängnis geworfen und schändlich behandelt worden war, als letzter von allen in Rom gekreuzigt.",
        },
        sourceReference: "Can. 9",
      },
      {
        id: "peter-alex-acts",
        author: {
        ...
        date: "c. 306 AD",
        text: {
          en: "Peter was the first of the apostles, Peter is the last of the martyred bishops of Alexandria.",
          fr: "Pierre fut le premier des apôtres, Pierre est le dernier des évêques martyrs d'Alexandrie.",
          es: "Pedro fue el primero de los apóstoles, Pedro es el último de los obispos mártires de Alejandría.",
          de: "Petrus war der erste der Apostel, Petrus ist der letzte der gemarterten Bischöfe von Alexandria.",
        },
      ...
      },
      {
        ...
        work: {
          en: "Of the Manner in Which the Persecutors Died",
          fr: "De la Mort des Persécuteurs",
          es: "Sobre la Muerte de los Perseguidores",
          de: "Von der Todesart der Verfolger",
        },
        date: "c. 318 AD",
        text: {
          en: "And while Nero reigned, the Apostle Peter came to Rome, and, through the power of God committed unto him, wrought certain miracles, and, by turning many to the true religion, built up a faithful and steadfast temple unto the Lord.",
          fr: "Et pendant que Néron régnait, l'Apôtre Pierre vint à Rome, et, par la puissance de Dieu qui lui avait été confiée, accomplit certains miracles, et, en convertissant beaucoup à la vraie religion, bâtit un temple fidèle et inébranlable au Seigneur.",
          es: "Y mientras Nerón reinaba, el Apóstol Pedro vino a Roma, y, por el poder de Dios confiado a él, obró ciertos milagros, y, convirtiendo a muchos a la verdadera religión, edificó un templo fiel y firme para el Señor.",
          de: "Und während Nero regierte, kam der Apostel Petrus nach Rom und wirkte durch die ihm anvertraute Kraft Gottes gewisse Wunder und baute, indem er viele zur wahren Religion bekehrte, einen treuen und standhaften Tempel für den Herrn auf.",
        },
        sourceReference: "Ch. 2",
      },
      {
        id: "eusebius-history-2-25",
        author: {
          en: "Eusebius of Caesarea",
          fr: "Eusèbe de Césarée",
          es: "Eusebio de Cesarea",
        ...
        date: "c. 312 AD",
        text: {
          en: "It is, therefore, recorded that Paul was beheaded in Rome itself, and that Peter likewise was crucified under Nero.",
          fr: "Il est donc rapporté que Paul a été décapité à Rome même, et que Pierre a également été crucifié sous Néron.",
          es: "Por lo tanto, está registrado que Pablo fue decapitado en la misma Roma, y que Pedro igualmente fue crucificado bajo Nerón.",
          de: "Es wird daher berichtet, dass Paulus in Rom selbst enthauptet wurde und dass Petrus ebenfalls unter Nero gekreuzigt wurde.",
        },
        sourceReference: "Book 2, Ch. 25, §5",
      },
      {
        id: "eusebius-history-3-4",
        author: {
          en: "Eusebius of Caesarea",
          fr: "Eusèbe de Césarée",
          es: "Eusebio de Cesarea",
        ...
        date: "c. 312 AD",
        text: {
          en: "Linus... was Peter’s successor in the episcopate of the church there... Clement also, who was appointed third bishop of the church at Rome...",
          fr: "Linus... était le successeur de Pierre dans l'épiscopat de l'église là-bas... Clément aussi, qui fut nommé troisième évêque de l'église à Rome...",
          es: "Lino... fue el sucesor de Pedro en el episcopado de la iglesia allí... Clemente también, quien fue nombrado tercer obispo de la iglesia en Roma...",
          de: "Linus... war der Nachfolger Petri im Episkopat der dortigen Kirche... Klemens auch, der zum dritten Bischof der Kirche in Rom ernannt wurde...",
        },
        sourceReference: "Book 3, Ch. 4, §§9-10",
      },
      {
        id: "eusebius-history-5-24",
        author: {
          en: "Eusebius of Caesarea",
          fr: "Eusèbe de Césarée",
          es: "Eusebio de Cesarea",
        ...
        date: "c. 312 AD",
        text: {
          en: "Thereupon Victor, who presided over the church at Rome, immediately attempted to cut off from the common unity the parishes of all Asia...",
          fr: "Sur ce, Victor, qui présidait l'église à Rome, tenta immédiatement de couper de l'unité commune les paroisses de toute l'Asie...",
          es: "Entonces Víctor, que presidía la iglesia en Roma, intentó inmediatamente cortar de la unidad común a las parroquias de toda Asia...",
          de: "Daraufhin versuchte Viktor, der der Kirche in Rom vorstand, sofort, die Gemeinden von ganz Asien von der gemeinsamen Einheit abzuschneiden...",
        },
        sourceReference: "Book 5, Ch. 24, §9",
      },
      {
        id: "eusebius-proof-3-5",
        author: {
          en: "Eusebius of Caesarea",
          fr: "Eusèbe de Césarée",
          es: "Eusebio de Cesarea",
        ...
        text: {
          ...
          es: "...o que Pedro, el apóstol y discípulo que era el jefe de todos ellos, Lo negó tres veces...",
          de: "...oder dass Petrus, der Apostel und Jünger, der das Oberhaupt von allen war, Ihn dreimal verleugnete...",
        },
    ...
    quotes: [
      {
        ...
        date: "c. 80 AD",
        text: {
          en: "But you, having been strengthened by the holy Angel, and having obtained from Him such intercession, and not being slothful, why do not you ask of the Lord understanding, and receive it from Him?",
          fr: "Mais toi, ayant été fortifié par le saint Ange, et ayant obtenu de Lui une telle intercession, et n'étant pas paresseux, pourquoi ne demandes-tu pas au Seigneur l'intelligence, et ne la reçois-tu pas de Lui ?",
          es: "Pero tú, habiendo sido fortalecido por el santo Ángel, y habiendo obtenido de Él tal intercesión, y no siendo perezoso, ¿por qué no pides al Señor entendimiento, y lo recibes de Él?",
          de: "Aber du, da du durch den heiligen Engel gestärkt worden bist und von Ihm eine solche Fürsprache erhalten hast und nicht träge bist, warum bittest du den Herrn nicht um Verständnis und empfängst es von Ihm?",
        },
...

      {
        id: "epitaph-sozon",
        author: {
          en: "Ancient Christian Inscription",
          fr: "Inscription Chrétienne Ancienne",
          es: "Inscripción Cristiana Antigua",
          de: "Altchristliche Inschrift",
        },
        work: {
          en: "Epitaph of Sozon",
          fr: "Épitaphe de Sozon",
          es: "Epitafio de Sozon",
          de: "Epitaph von Sozon",
        },
        date: "c. 250 AD",
        text: {
          en: "Blessed Sozon gave back (his soul) aged nine years; may the true Christ (receive) your spirit in peace, and pray for us.",
          fr: "Le bienheureux Sozon a rendu (son âme) âgé de neuf ans ; que le vrai Christ (reçoive) ton esprit en paix, et prie pour nous.",
          es: "El bienaventurado Sozon entregó (su alma) a la edad de nueve años; que el verdadero Cristo (reciba) tu espíritu en paz, y ruega por nosotros.",
          de: "Der selige Sozon gab (seine Seele) zurück im Alter von neun Jahren; möge der wahre Christus deinen Geist in Frieden (empfangen), und bitte für uns.",
        },
        sourceReference: "Christian Inscriptions",
      },
      {
        id: "epitaph-gentianus",
        author: {
          en: "Ancient Christian Inscription",
          fr: "Inscription Chrétienne Ancienne",
          es: "Inscripción Cristiana Antigua",
        ...
        work: {
          en: "Epitaph of Gentianus",
          fr: "Épitaphe de Gentianus",
          es: "Epitafio de Gentianus",
          de: "Epitaph von Gentianus",
        },
        date: "c. 250 AD",
        text: {
          en: "Gentianus, a believer, in peace, who lived twenty-one years eight months sixteen days, and in thy prayers ask for us, because we know that thou art in Christ.",
          fr: "Gentianus, un croyant, en paix, qui a vécu vingt et un ans huit mois seize jours, et dans tes prières demande pour nous, car nous savons que tu es en Christ.",
          es: "Gentianus, un creyente, en paz, que vivió veintiún años ocho meses dieciséis días, y en tus oraciones pide por nosotros, porque sabemos que estás en Cristo.",
          de: "Gentianus, ein Gläubiger, in Frieden, der einundzwanzig Jahre acht Monate sechzehn Tage lebte, und in deinen Gebeten bitte für uns, denn wir wissen, dass du in Christus bist.",
        },
        sourceReference: "Christian Inscriptions",
      },
      {
        id: "epitaph-matronata",
        author: {
          en: "Ancient Christian Inscription",
          fr: "Inscription Chrétienne Ancienne",
          es: "Inscripción Cristiana Antigua",
        ...
        work: {
          en: "Epitaph of Matronata Matrona",
          fr: "Épitaphe de Matronata Matrona",
          es: "Epitafio de Matronata Matrona",
          de: "Epitaph von Matronata Matrona",
        },
        date: "c. 250 AD",
        text: {
          en: "Pray for your parents, Matronata Matrona. She lived one year, fifty-two days.",
          fr: "Prie pour tes parents, Matronata Matrona. Elle a vécu un an, cinquante-deux jours.",
          es: "Ruega por tus padres, Matronata Matrona. Vivió un año, cincuenta y dos días.",
          de: "Bete für deine Eltern, Matronata Matrona. Sie lebte ein Jahr, zweiundfünfzig Tage.",
        },
        sourceReference: "Christian Inscriptions",
      },
...

      {
        id: "rylands-papyrus",
        author: {
          en: "Ancient Christian Prayer",
          fr: "Ancienne Prière Chrétienne",
          es: "Antigua Oración Cristiana",
          de: "Altchristliches Gebet",
        },
        work: {
          en: "Sub Tuum Praesidium (Rylands Papyrus 470)",
          fr: "Sub Tuum Praesidium (Papyrus Rylands 470)",
          es: "Sub Tuum Praesidium (Papiro Rylands 470)",
          de: "Sub Tuum Praesidium (Papyrus Rylands 470)",
        },
        date: "c. 300 AD",
        text: {
          en: "Mother of God (hear) my supplications: suffer us not (to be) in adversity, but deliver us from danger. Thou alone...",
          fr: "Mère de Dieu (entends) mes supplications : ne nous laisse pas (être) dans l'adversité, mais délivre-nous du danger. Toi seule...",
          es: "Madre de Dios (escucha) mis súplicas: no nos dejes (estar) en la adversidad, sino líbranos del peligro. Tú sola...",
          de: "Mutter Gottes (erhöre) meine Bitten: lass uns nicht in Widrigkeiten (sein), sondern erlöse uns von der Gefahr. Du allein...",
        },
    ...
    quotes: [
      {
        ...
        work: {
          en: "Epitaph of Agape",
          fr: "Épitaphe d'Agape",
          es: "Epitafio de Ágape",
          de: "Epitaph der Agape",
        },
        date: "c. 150 AD",
        text: {
          en: "I pray you, O brethren, to pray when you come here, and to ask in your common prayers the Father and the Son. May it be in your minds to remember dear Agape that the omnipotent God may keep Agape safe forever.",
          fr: "Je vous prie, ô frères, de prier quand vous venez ici, et de demander dans vos prières communes au Père et au Fils. Ayez à l'esprit de vous souvenir de la chère Agape afin que le Dieu tout-puissant garde Agape en sécurité pour toujours.",
          es: "Os ruego, hermanos, que oréis cuando vengáis aquí, y que pidáis en vuestras oraciones comunes al Padre y al Hijo. Tened en vuestras mentes recordar a la querida Ágape para que el Dios omnipotente guarde a Ágape a salvo para siempre.",
          de: "Ich bitte euch, o Brüder, zu beten, wenn ihr hierher kommt, und in euren gemeinsamen Gebeten den Vater und den Sohn zu bitten. Möget ihr im Sinn haben, der lieben Agape zu gedenken, damit der allmächtige Gott Agape für immer sicher bewahre.",
        },
        sourceReference: "Christian Inscriptions",
      },
      {
        ...
        work: {
          en: "The Acts of Paul and Thecla",
          fr: "Les Actes de Paul et Thècle",
          es: "Los Hechos de Pablo y Tecla",
          de: "Die Akten des Paulus und der Thekla",
        },
        date: "c. 160 AD",
        text: {
          en: "Mother, you shall have this stranger Thecla in my place, in order that she may pray concerning me, and that I may be transferred to the place of the just.",
          fr: "Mère, tu auras cette étrangère Thècle à ma place, afin qu'elle puisse prier pour moi, et que je sois transférée au lieu des justes.",
          es: "Madre, tendrás a esta extranjera Tecla en mi lugar, para que ella pueda orar por mí, y que yo sea transferida al lugar de los justos.",
          de: "Mutter, du sollst diese Fremde Thekla an meiner Stelle haben, damit sie für mich betet und ich an den Ort der Gerechten versetzt werde.",
        },
        sourceReference: "Ch. 29",
      },
      {
        id: "epitaph-abercius",
        author: {
        ...
        work: {
          en: "Epitaph of Abercius",
          fr: "Épitaphe d'Abercius",
          es: "Epitafio de Abercio",
          de: "Epitaph des Aberkios",
        },
        date: "c. 190 AD",
        text: {
          en: "I, the citizen of a chosen city, erected this in my lifetime that I may have in time to come a place wherein to lay my body... Let him who understands this, and everyone who agrees therewith, pray for Abercius.",
          fr: "Moi, le citoyen d'une ville élue, j'ai érigé ceci de mon vivant afin d'avoir dans les temps à venir un lieu où déposer mon corps... Que celui qui comprend ceci, et tous ceux qui sont d'accord, prient pour Abercius.",
          es: "Yo, ciudadano de una ciudad elegida, erigí esto en mi vida para tener en el tiempo venidero un lugar donde depositar mi cuerpo... Que el que entienda esto, y todos los que estén de acuerdo, oren por Abercio.",
          de: "Ich, der Bürger einer auserwählten Stadt, habe dies zu meinen Lebzeiten errichtet, damit ich in kommender Zeit einen Ort habe, um meinen Körper niederzulegen... Wer dies versteht, und jeder, der damit übereinstimmt, möge für Aberkios beten.",
        },
