export const reformationTranslations = {
  en: {
    title: "Reformation History: Myths, Men, and Morality",
    ...
    vid2aText: "We often hear that Luther championed 'Scripture alone' but we rarely hear about what he attacked which was Reason. Luther famously called Reason 'the Devil's Whore' and expressed a deep hatred for Aristotle and Scholasticism. This video explores his extreme arrogance where he claimed to understand Scripture better than all Church Fathers combined and how his rejection of the synthesis between Faith and Reason led to a theology based purely on emotion and will.",
    ...
    vid3aText: "Most of what people 'know' about Luther is movie magic rather than history. For example he likely never nailed the 95 Theses to the door as it was a mailed letter. He almost certainly never said the famous 'Here I Stand' line at the Diet of Worms. And he was absolutely not the first person to give the German people a Bible as there were 18 authorized German Catholic translations in print before Luther was even born.",
    ...
    vid4Text: "When confronted with the dark history or the erratic theology of the Reformers many modern Protestants reply that 'Luther isn't my Pope as I just follow the Bible.' This video explains why this is a cop out. You cannot adopt the specific theological innovations of the Reformation like Sola Fide and Sola Scriptura and the 66 book canon while disavowing the men who invented them. If the tree is rotten then the fruit is rotten."
  },
  es: {
    title: "Historia de la Reforma: Mitos, Hombres y Moralidad",
    subtitle: "Una inmersión profunda en la realidad histórica de la Reforma Protestante para separar los hechos reales de las leyendas posteriores.",
    tocTitle: "En Esta Página",
    
    natureTitle: "La Naturaleza de la División",
    natureDesc: "El protestantismo a menudo se presenta como un retorno al cristianismo 'original' pero histórica y teológicamente opera más como una reacción que como una fe independiente. Esta sección explora por qué lucha por mantener la unidad sin la Iglesia Católica como punto de referencia.",
    vid1Title: "El Protestantismo Necesita del Catolicismo para Existir",
    vid1Text: "Brian Holdsworth presenta la analogía del 'Anillo alrededor de Saturno' para explicar la fragmentación del protestantismo. Argumenta que el protestantismo carece de un principio unificador interno ya que se define enteramente por lo que se opone que es Roma. Si la Iglesia Católica desapareciera mañana entonces el protestantismo perdería su definición y se disolvería en miles de sectas no relacionadas. Lo único que une a un bautista y un luterano y un pentecostal es su protesta compartida contra el Papa.",

    lutherTitle: "Deconstruyendo a Martín Lutero",
    lutherDesc: "Martín Lutero es posiblemente la figura más influyente del último milenio. Pero la imagen popular de él como un héroe de conciencia humilde e inquebrantable a menudo choca con sus escritos y comportamiento reales. Para entender la Reforma debemos entender al hombre que la inició.",
    vid2aTitle: "La Guerra Narcisista de Lutero contra la Filosofía",
    ...
    vid3aTitle: "8 Mitos sobre Martín Lutero",
    vid3aText: "La mayor parte de lo que la gente 'sabe' sobre Lutero es magia de cine y no historia. Por ejemplo es probable que nunca clavó las 95 Tesis en la puerta ya que fue una carta enviada. Casi con certeza nunca dijo la famosa frase 'Aquí estoy' en la Dieta de Worms. Y absolutamente no fue la primera persona en dar una Biblia al pueblo alemán pues había 18 traducciones católicas alemanas autorizadas impresas antes de que Lutero naciera.",
    vid3bTitle: "El Mito de los Mártires Bíblicos Protestantes",
    vid3bText: "Una acusación común es que la Iglesia Católica ejecutó a William Tyndale solo por traducir la Biblia. Esto es falso. La Iglesia había autorizado Biblias vernáculas durante siglos. Tyndale y otros como Wycliffe fueron castigados por el Estado por herejía y sedición. Específicamente fue por crear traducciones erróneas intencionales diseñadas para incitar a la rebelión contra la jerarquía tal como cambiar 'Iglesia' por 'Congregación' y 'Sacerdote' por 'Anciano' para socavar la autoridad apostólica.",

    modernTitle: "La Defensa Moderna",
    modernDesc: "Cuando se enfrentan a la difícil historia de la Reforma una defensa moderna común es simplemente distanciarse de los Reformadores mientras se intenta mantener su teología. Esta sección explora por qué ese enfoque es intelectualmente fatal.",
    vid4Title: "La Peor Respuesta Protestante",
    vid4Text: "Cuando se enfrentan a la oscura historia o la teología errática de los Reformadores muchos protestantes modernos responden que 'Lutero no es mi Papa y solo sigo la Biblia.' Este video explica por qué esto es una excusa. No puedes adoptar las innovaciones teológicas específicas de la Reforma como Sola Fide y Sola Scriptura y el canon de 66 libros mientras repudias a los hombres que las inventaron. Si el árbol está podrido entonces la fruta está podrida."
  },
  fr: {
    title: "Histoire de la Réforme : Mythes, Hommes et Moralité",
    subtitle: "Une plongée profonde dans la réalité historique de la Réforme protestante pour séparer les événements réels des légendes ultérieures.",
    tocTitle: "Sur Cette Page",
    
    natureTitle: "La Nature de la Séparation",
    natureDesc: "Le protestantisme est souvent présenté comme un retour au christianisme 'original' mais historiquement et théologiquement il fonctionne davantage comme une réaction que comme une foi autonome. Cette section explore pourquoi il peine à maintenir l'unité sans l'Église catholique comme point de référence.",
    vid1Title: "Le Protestantisme a Besoin du Catholicisme pour Exister",
    vid1Text: "Brian Holdsworth présente l'analogie de 'l'Anneau autour de Saturne' pour expliquer la fragmentation du protestantisme. Il soutient que le protestantisme manque d'un principe unificateur interne car il est défini entièrement par ce qu'il oppose qui est Rome. Si l'Église catholique disparaissait demain alors le protestantisme perdrait sa définition et se dissoudrait en milliers de sectes sans lien. La seule chose qui lie un baptiste et un luthérien et un pentecôtiste est leur protestation commune contre le Pape.",

    lutherTitle: "Déconstruire Martin Luther",
    lutherDesc: "Martin Luther est sans doute la figure la plus influente du dernier millénaire. Mais l'image populaire de lui comme un héros de conscience humble et inébranlable se heurte souvent à ses écrits et à son comportement réels. Pour comprendre la Réforme nous devons comprendre l'homme qui l'a commencée.",
    vid2aTitle: "La Guerre Narcissique de Luther contre la Philosophie",
    vid2aText: "Nous entendons souvent dire que Luther a défendu 'l'Écriture seule' mais nous entendons rarement parler de ce qu'il a attaqué qui était la Raison. Luther a qualifié la Raison de 'putain du Diable' et a exprimé une haine profonde pour Aristote et la scolastique. Cette vidéo explore son arrogance extrême où il prétendait comprendre les Écritures mieux que tous les Pères de l'Église réunis et comment son rejet de la synthèse entre la Foi et la Raison a conduit à une théologie basée uniquement sur l'émotion et la volonté.",
    ...
    vid3bText: "Une accusation courante est que l'Église catholique a exécuté William Tyndale juste pour avoir traduit la Bible. C'est faux. L'Église autorisait les Bibles vernaculaires depuis des siècles. Tyndale et d'autres comme Wycliffe ont été punis par l'État pour hérésie et sédition. Spécifiquement c'était pour avoir créé des traductions erronées intentionnelles conçues pour inciter à la rébellion contre la hiérarchie en changeant par exemple 'Église' par 'Congrégation' et 'Prêtre' par 'Ancien' pour saper l'autorité apostolique.",

    modernTitle: "La Défense Moderne",
    modernDesc: "Face à l'histoire difficile de la Réforme une défense moderne courante consiste simplement à se distancier des Réformateurs tout en essayant de conserver leur théologie. Cette section explore pourquoi cette approche est intellectuellement fatale.",
    vid4Title: "La Pire Réponse Protestante",
    vid4Text: "Face à l'histoire sombre ou à la théologie erratique des Réformateurs de nombreux protestants modernes répondent que 'Luther n'est pas mon Pape et je suis juste la Bible.' Cette vidéo explique pourquoi c'est une échappatoire. Vous ne pouvez pas adopter les innovations théologiques spécifiques de la Réforme comme Sola Fide et Sola Scriptura et le canon de 66 livres tout en désavouant les hommes qui les ont inventées. Si l'arbre est pourri alors le fruit est pourri."
  },
  de: {
    title: "Reformationsgeschichte: Mythen, Männer und Moral",
    subtitle: "Ein tiefer Einblick in die historische Realität der protestantischen Reformation um die tatsächlichen Ereignisse von den späteren Legenden zu trennen.",
    tocTitle: "Auf dieser Seite",
    
    natureTitle: "Die Natur der Spaltung",
    natureDesc: "Der Protestantismus wird oft als Rückkehr zum 'ursprünglichen' Christentum dargestellt aber historisch und theologisch funktioniert er eher als Reaktion denn als eigenständiger Glaube. Dieser Abschnitt untersucht warum er ohne die katholische Kirche als Bezugspunkt nur schwer Einheit bewahren kann.",
    vid1Title: "Protestantismus braucht Katholizismus um zu existieren",
    vid1Text: "Brian Holdsworth präsentiert die 'Ring um Saturn' Analogie um die Fragmentierung des Protestantismus zu erklären. Er argumentiert dass dem Protestantismus ein internes vereinigendes Prinzip fehlt da er sich ausschließlich durch das definiert wogegen er sich stellt und das ist Rom. Wenn die katholische Kirche morgen verschwinden würde dann würde der Protestantismus seine Definition verlieren und sich in tausende unzusammenhängende Sekten auflösen. Das Einzige was einen Baptisten und einen Lutheraner und einen Pfingstler verbindet ist ihr gemeinsamer Protest gegen den Papst.",

    lutherTitle: "Dekonstruktion von Martin Luther",
    lutherDesc: "Martin Luther ist wohl die einflussreichste Figur des letzten Jahrtausends. Aber das populäre Bild von ihm als bescheidenem und unerschütterlichem Gewissenshelden kollidiert oft mit seinen tatsächlichen Schriften und seinem Verhalten. Um die Reformation zu verstehen müssen wir den Mann verstehen der sie begann.",
    ...
    vid3aText: "Das meiste was die Leute über Luther 'wissen' ist Filmmagie und keine Geschichte. Zum Beispiel hat er wahrscheinlich nie die 95 Thesen an die Tür genagelt da es ein Brief war. Er hat fast sicher nie den berühmten Satz 'Hier stehe ich' auf dem Reichstag zu Worms gesagt. Und er war absolut nicht die erste Person die dem deutschen Volk eine Bibel gab denn es gab 18 autorisierte deutsche katholische Übersetzungen im Druck bevor Luther überhaupt geboren wurde.",
    vid3bTitle: "Der Mythos der protestantischen Bibelmärtyrer",
    vid3bText: "Ein häufiger Vorwurf ist dass die katholische Kirche William Tyndale nur hingerichtet hat weil er die Bibel übersetzt hat. Das ist falsch. Die Kirche hatte jahrhundertelang volkssprachliche Bibeln autorisiert. Tyndale und andere wie Wycliffe wurden vom Staat wegen Häresie und Aufruhr bestraft. Speziell ging es um die Erstellung absichtlicher Fehlübersetzungen die darauf ausgelegt waren Rebellion gegen die Hierarchie anzustiften wie z. B. die Änderung von 'Kirche' in 'Versammlung' und 'Priester' in 'Ältester' um die apostolische Autorität zu untergraben.",

    modernTitle: "Die moderne Verteidigung",
    modernDesc: "Wenn man mit der schwierigen Geschichte der Reformation konfrontiert wird ist eine übliche moderne Verteidigung sich einfach von den Reformatoren zu distanzieren während man versucht ihre Theologie beizubehalten. Dieser Abschnitt untersucht warum dieser Ansatz intellektuell fatal ist.",
    vid4Title: "Die schlechteste protestantische Antwort",
    vid4Text: "Wenn sie mit der dunklen Geschichte oder der sprunghaften Theologie der Reformatoren konfrontiert werden antworten viele moderne Protestanten mit 'Luther ist nicht mein Papst denn ich folge nur der Bibel.' Dieses Video erklärt warum dies eine Ausrede ist. Man kann nicht die spezifischen theologischen Innovationen der Reformation wie Sola Fide und Sola Scriptura und den 66 Bücher Kanon übernehmen während man die Männer verleugnet die sie erfunden haben. Wenn der Baum faul ist dann ist die Frucht faul."
  }
};
